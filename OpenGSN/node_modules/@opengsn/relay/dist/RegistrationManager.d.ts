...
export declare class RegistrationManager {
    ...
    init(): Promise<void>;
    updateLatestRegistrationTxs(hubEventsSinceLastScan: EventData[]): Promise<void>;
