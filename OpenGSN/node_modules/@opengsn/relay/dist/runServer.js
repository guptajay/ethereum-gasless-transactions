...
async function run() {
    ...
    try {
        ...
        const loggingProvider = (_a = conf.loggingProvider) !== null && _a !== void 0 ? _a : false;
    ...
    const txStoreManager = new TxStoreManager_1.TxStoreManager({ workdir, autoCompactionInterval: config.dbAutoCompactionInterval }, logger);
    ...
    const contractInteractor = new ContractInteractor_1.ContractInteractor({
        ...
        versionManager: new common_1.VersionsManager(common_1.gsnRuntimeVersion, (_b = config.requiredVersionRange) !== null && _b !== void 0 ? _b : common_1.gsnRequiredVersion),
