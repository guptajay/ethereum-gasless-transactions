...
function createWeb3Transaction(transaction, rawTxOptions) {
    ...
    return new tx_1.Transaction(txData, rawTxOptions);
}
/**
...
class PenalizerService {
    ...
    async penalizeRepeatedNonce(req) {
        ...
        const requestTx = tx_1.Transaction.fromSerializedTx(ethereumjs_util_1.toBuffer(req.signedTx), rawTxOptions);
        ...
        const relayWorker = ethereumjs_util_1.bufferToHex(requestTx.getSenderAddress().toBuffer());
    ...
    async isTransactionMined(requestTx) {
        const txFromNode = await this.contractInteractor.getTransaction(ethereumjs_util_1.bufferToHex(requestTx.hash()));
