...
(async () => {
    ...
    const logic = new CommandsLogic_1.CommandsLogic(nodeURL, logger, {}, mnemonic);
    ...
    const contractInteractor = new ContractInteractor_1.ContractInteractor({ provider, logger, deployment, maxPageSize });
    const versionRegistry = new VersionRegistry_1.VersionRegistry(1, contractInteractor);
