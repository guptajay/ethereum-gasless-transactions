...
const AuditRequest_1 = require("@opengsn/common/dist/types/AuditRequest");
const RelayTransactionRequest_1 = require("@opengsn/common/dist/types/RelayTransactionRequest");
class HttpServer {
    ...
    close() {
        ...
        (_b = this.penalizerService) === null || _b === void 0 ? void 0 : _b.stop();
    }
