...
import { PaymasterGasAndDataLimits } from '@opengsn/common/dist/Utils';
...
export declare class RelayServer extends EventEmitter {
    ...
    trustedPaymastersGasAndDataLimits: Map<String | undefined, PaymasterGasAndDataLimits>;
    ...
    validatePaymasterGasAndDataLimits(req: RelayTransactionRequest): Promise<{
        maxPossibleGas: number;
        acceptanceBudget: number;
    }>;
    validateViewCallSucceeds(req: RelayTransactionRequest, maxAcceptanceBudget: number, maxPossibleGas: number): Promise<void>;
