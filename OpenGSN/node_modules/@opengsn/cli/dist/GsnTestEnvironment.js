...
const ServerWinstonLogger_1 = require("@opengsn/relay/dist/ServerWinstonLogger");
...
class GsnTestEnvironmentClass {
    ...
    async startGsn(host) {
        ...
        const deploymentResult = await commandsLogic.deployGsnContracts({
            ...
            penalizerConfiguration: Environments_1.defaultEnvironment.penalizerConfiguration,
