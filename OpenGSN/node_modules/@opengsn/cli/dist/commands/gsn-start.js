...
(async () => {
    try {
        ...
        const env = await GsnTestEnvironment_1.GsnTestEnvironment.startGsn(network);
        utils_1.saveDeployment(env.contractsDeployment, commander_1.default.workdir);
        utils_1.showDeployment(env.contractsDeployment, 'GSN started');
