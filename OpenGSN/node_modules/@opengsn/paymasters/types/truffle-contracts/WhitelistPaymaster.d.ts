...
export interface WhitelistPaymasterContract
  extends Truffle.Contract<WhitelistPaymasterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<WhitelistPaymasterInstance>;
}
...
export interface WhitelistPaymasterInstance extends Truffle.ContractInstance {
  ...
  useSenderWhitelist(txDetails?: Truffle.TransactionDetails): Promise<boolean>;

  useTargetWhitelist(txDetails?: Truffle.TransactionDetails): Promise<boolean>;
