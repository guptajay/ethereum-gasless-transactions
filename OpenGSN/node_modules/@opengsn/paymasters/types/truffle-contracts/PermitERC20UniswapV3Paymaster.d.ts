...
export interface PermitERC20UniswapV3PaymasterContract
  extends Truffle.Contract<PermitERC20UniswapV3PaymasterInstance> {
  "new"(
    _weth: string,
    _token: string,
    _relayHub: string,
    ...
    _uniswapPoolFee: number | BN | string,
    _gasUsedByPost: number | BN | string,
    _permitMethodDataLength: number | BN | string,
    _permitMethodSignature: string,
    meta?: Truffle.TransactionDetails
  ): Promise<PermitERC20UniswapV3PaymasterInstance>;
}
...
type AllEvents = OwnershipTransferred | Received | TokensCharged;

export interface PermitERC20UniswapV3PaymasterInstance
  ...
  gasUsedByPost(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  permitMethodDataLength(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  permitMethodSignature(
    txDetails?: Truffle.TransactionDetails
  ): Promise<string>;
  ...
  uniswapPoolFee(txDetails?: Truffle.TransactionDetails): Promise<BN>;
  ...
  setTrustedForwarder: {
    (_forwarder: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      _forwarder: string,
  ...
  /**
   * set gas used by postRelayedCall, for proper gas calculation. You can use TokenGasCalculator to calculate these values (they depend on actual code of postRelayedCall, but also the gas usage of the token and of Uniswap)
   */
  setPostGasUsage: {
    (
      _gasUsedByPost: number | BN | string,
