...
export interface TestHubContract extends Truffle.Contract<TestHubInstance> {
  "new"(
...
export interface TestHubInstance extends Truffle.ContractInstance {
