...
export interface VerifyingPaymasterContract
  extends Truffle.Contract<VerifyingPaymasterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<VerifyingPaymasterInstance>;
}
...
export interface VerifyingPaymasterInstance extends Truffle.ContractInstance {
  ...
  setSigner: {
    (_signer: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      _signer: string,
