...
export interface ProxyDeployingPaymasterContract
  extends Truffle.Contract<ProxyDeployingPaymasterInstance> {
  "new"(
    _uniswaps: string[],
    _proxyFactory: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ProxyDeployingPaymasterInstance>;
}
...
export interface ProxyDeployingPaymasterInstance
  ...
  proxyFactory(txDetails?: Truffle.TransactionDetails): Promise<string>;
