...
export interface HashcashPaymasterContract
  extends Truffle.Contract<HashcashPaymasterInstance> {
  "new"(
    _difficulty: number | BN | string,
    meta?: Truffle.TransactionDetails
  ): Promise<HashcashPaymasterInstance>;
}
...
export interface HashcashPaymasterInstance extends Truffle.ContractInstance {
  ...
  difficulty(txDetails?: Truffle.TransactionDetails): Promise<BN>;
